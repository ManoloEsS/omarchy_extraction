-- Window lifecycle, layout, workspaces, and groups.

local o = require("hypr.helpers")

o.bind("SUPER + W", "Close window", hl.dsp.window.close())
o.bind("CTRL + ALT + Delete", "Close all windows", "desk-close-all")
...
o.bind("SUPER + O", "Pop window out", "desk-window-pop")
o.bind("SUPER + L", "Toggle workspace layout", "desk-workspace-layout-toggle")
...
o.bind("SUPER + SHIFT + ALT + UP", "Move workspace to upper monitor", hl.dsp.workspace.move({ monitor = "u" }))
o.bind("SUPER + SHIFT + ALT + DOWN", "Move workspace to lower monitor", hl.dsp.workspace.move({ monitor = "d" }))
...
o.bind("SUPER + ALT + LEFT", "Move window to group on the left", hl.dsp.window.move({ into_group = "l" }))
o.bind("SUPER + ALT + RIGHT", "Move window to group on the right", hl.dsp.window.move({ into_group = "r" }))
o.bind("SUPER + ALT + UP", "Move window to group above", hl.dsp.window.move({ into_group = "u" }))
o.bind("SUPER + ALT + DOWN", "Move window to group below", hl.dsp.window.move({ into_group = "d" }))
